---
parent: Entities
title: csolink:AdministrativeOperationalToComponentserviceInteractionExposure
grand_parent: Classes
layout: default
---

# Class: AdministrativeOperationalToComponentserviceInteractionExposure
...
URI: [csolink:AdministrativeOperationalToComponentserviceInteractionExposure](https://w3id.org/csolink/vocab/AdministrativeOperationalToComponentserviceInteractionExposure)


---

![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SystemTaxon],[NamedThing],[ControlActor],[ComponentserviceGroupingMixin],[Componentservice],[Attribute],[Agent],[AdministrativeOperationalToComponentserviceInteractionExposure%7Ctimepoint(i):time_type%20%3F;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F]uses%20-.-%3E[ComponentserviceGroupingMixin],[AdministrativeOperationalExposure]%5E-[AdministrativeOperationalToComponentserviceInteractionExposure],[AdministrativeOperationalExposure])
 ...
 *  is_a: [AdministrativeOperationalExposure](AdministrativeOperationalExposure.md) - A administrative operational exposure is an intake of a particular administrative operation.
