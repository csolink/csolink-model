---
parent: Predicates
title: csolink:affects_molecular_modification_of
grand_parent: Slots
layout: default
---
...
URI: [csolink:affects_molecular_modification_of](https://w3id.org/csolink/vocab/affects_molecular_modification_of)
