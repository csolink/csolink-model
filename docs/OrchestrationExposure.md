---
parent: Entities
title: csolink:OrchestrationExposure
...
URI: [csolink:OrchestrationExposure](https://w3id.org/csolink/vocab/OrchestrationExposure)


---

![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SystemTaxon],[OrchestrationExposure%7Ctimepoint:time_type%20%3F;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F]uses%20-.-%3E[ExposureEvent],[OrchestrationExposure]%5E-[ComplexOrchestrationExposure],[ControlActor]%5E-[OrchestrationExposure],[NamedThing],[ExposureEvent],[ControlActor],[ComplexOrchestrationExposure],[Attribute],[Agent])
