...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SystemTaxon],[NamedThing],[IndividualSystem],[CaseToEntityAssociationMixin],[CaseToEntityAssociationMixin]-%20subject%201..1%3E[Case%7Cid(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F],[IndividualSystem]%5E-[Case],[Attribute],[Agent])
 ...
 *  is_a: [IndividualSystem](IndividualSystem.md) - An instance of an system. For example, Richard Nixon, Charles Darwin, my pet cat. Example ID: ORCID:0000-0002-5355-2576
