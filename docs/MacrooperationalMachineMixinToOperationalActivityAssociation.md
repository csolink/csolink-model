---
parent: Associations
title: csolink:MacrooperationalMachineMixinToOperationalActivityAssociation
grand_parent: Classes
layout: default
---

# Class: MacrooperationalMachineMixinToOperationalActivityAssociation
...
URI: [csolink:MacrooperationalMachineMixinToOperationalActivityAssociation](https://w3id.org/csolink/vocab/MacrooperationalMachineMixinToOperationalActivityAssociation)


---

![img](http://yuml.me/diagram/nofunky;dir:TB/class/[Publication],[OperationalActivity],[OntologyClass],[OperationalActivity]%3Cobject%201..1-%20[MacrooperationalMachineMixinToOperationalActivityAssociation%7Cpredicate(i):predicate_type;relation(i):uriorcurie;negated(i):boolean%20%3F;type(i):string%20%3F;id(i):string;iri(i):iri_type%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F],[FunctionalAssociation]%5E-[MacrooperationalMachineMixinToOperationalActivityAssociation],[MacrooperationalMachineMixin],[FunctionalAssociation],[Attribute],[Association],[Agent])
 ...
 * [macrooperational machine mixin to operational activity association➞object](macrooperational_machine_mixin_to_operational_activity_association_object.md)  <sub>REQ</sub>
    * range: [OperationalActivity](OperationalActivity.md)
