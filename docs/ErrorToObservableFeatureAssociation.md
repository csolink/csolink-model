---
parent: Associations
title: csolink:ErrorToObservableFeatureAssociation
grand_parent: Classes
layout: default
---

# Class: ErrorToObservableFeatureAssociation
...
URI: [csolink:ErrorToObservableFeatureAssociation](https://w3id.org/csolink/vocab/ErrorToObservableFeatureAssociation)


---

![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SeverityValue],[Publication],[OntologyClass],[Onset],[NamedThing],[FrequencyValue],[ErrorToObservableFeatureAssociation%7Cpredicate(i):predicate_type;relation(i):uriorcurie;negated(i):boolean%20%3F;type(i):string%20%3F;id(i):string;iri(i):iri_type%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F]uses%20-.-%3E[EntityToObservableFeatureAssociationMixin],[ErrorToObservableFeatureAssociation]uses%20-.-%3E[ErrorToEntityAssociationMixin],[Association]%5E-[ErrorToObservableFeatureAssociation],[ErrorToEntityAssociationMixin],[EntityToObservableFeatureAssociationMixin],[ComputationalArchitecturalStyle],[Attribute],[Association],[Agent])
