---
parent: Associations
title: csolink:CaseToPhenotypicFeatureAssociation
...
URI: [csolink:CaseToPhenotypicFeatureAssociation](https://w3id.org/csolink/vocab/CaseToPhenotypicFeatureAssociation)
