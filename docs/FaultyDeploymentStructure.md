---
parent: Entities
title: csolink:FaultyDeploymentStructure
grand_parent: Classes
layout: default
---

# Class: FaultyDeploymentStructure
...
URI: [csolink:FaultyDeploymentStructure](https://w3id.org/csolink/vocab/FaultyDeploymentStructure)


---

![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SystemTaxon],[NamedThing],[FaultyEntityMixin],[FaultyDeploymentStructure%7Cid(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F]uses%20-.-%3E[FaultyEntityMixin],[FaultyDeploymentStructure]%5E-[FaultyDeploymentOutcome],[FaultyDeploymentStructure]%5E-[FaultyDeploymentExposure],[DeploymentEntity]%5E-[FaultyDeploymentStructure],[FaultyDeploymentOutcome],[FaultyDeploymentExposure],[DeploymentEntity],[Attribute],[Agent])
 ...
 *  mixin: [FaultyEntityMixin](FaultyEntityMixin.md) - A faulty (abnormal) structure or process.
