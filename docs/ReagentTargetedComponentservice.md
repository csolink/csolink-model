---
parent: Entities
title: csolink:ReagentTargetedComponentservice
grand_parent: Classes
layout: default
---

# Class: ReagentTargetedComponentservice
...
URI: [csolink:ReagentTargetedComponentservice](https://w3id.org/csolink/vocab/ReagentTargetedComponentservice)


---

![img](http://yuml.me/diagram/nofunky;dir:TB/class/[WorkloadEntity],[SystemTaxon],[WorkloadEntity]%5E-[ReagentTargetedComponentservice%7Chas_computational_sequence(i):computational_sequence%20%3F;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F],[NamedThing],[Attribute],[Agent])
