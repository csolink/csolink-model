---
parent: Entities
title: csolink:ComputationalProcessOrActivity
...
URI: [csolink:ComputationalProcessOrActivity](https://w3id.org/csolink/vocab/ComputationalProcessOrActivity)


---

![img](http://yuml.me/diagram/nofunky;dir:TB/class/[OperationalActivity],[Occurrent],[NamedThing],[CyberEntity],[CyberEntity]%3Cenabled%20by%200..%2A-%20[ComputationalProcessOrActivity%7Cid(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F],[NamedThing]%3Chas%20output%200..%2A-%20[ComputationalProcessOrActivity],[NamedThing]%3Chas%20input%200..%2A-%20[ComputationalProcessOrActivity],[ComputationalProcessOrActivity]uses%20-.-%3E[Occurrent],[ComputationalProcessOrActivity]%5E-[OperationalActivity],[ComputationalProcessOrActivity]%5E-[ComputationalProcess],[ComputationalEntity]%5E-[ComputationalProcessOrActivity],[ComputationalProcess],[ComputationalEntity],[Attribute],[Agent])
