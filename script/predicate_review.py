        ...
        with open(self.predicates, 'r') as predicates:
            ...
            for line in predicates:
                ...
                if n % 10:
                    ...
                    # Review log predicates with "Csolink Slot" mappings (i.e. edge_label mapped predicates)
                    if field[5]:
                        ...
                        # is already identical to the Csolink predicate
                        if field[2] == field[5]:
                            print("Source ID equals Csolink Slot: ", field[0], "|", field[1], "|", field[2], "|", field[5], file=self.log)
                            continue

                        print("Check: ", field[0], "|", field[1], "|", field[2], "|", field[5], file=self.log)

                    elif field[2]:
                        #  Perhaps we can now use a non-empty "Source Relationship ID" to attempt a Csolink Mapping
