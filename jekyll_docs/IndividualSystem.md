---
parent: Entities
title: csolink:IndividualSystem
...
URI: [csolink:IndividualSystem](https://w3id.org/csolink/vocab/IndividualSystem)


---

![img](http://yuml.me/diagram/nofunky;dir:TB/class/[ThingWithTaxon],[SystemicEntity],[SystemTaxon],[NamedThing],[IndividualSystem%7Cid(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F]uses%20-.-%3E[ThingWithTaxon],[IndividualSystem]%5E-[Case],[SystemicEntity]%5E-[IndividualSystem],[Case],[Attribute],[Agent])
...
| --- | --- | --- |
| **Aliases:** | | system |
| **Exact Mappings:** | | csrc:system |
|  | | NCIT:C25700 |
|  | | RO:0002577 |
|  | | ssn:System |
| **Narrow Mappings:** | | CSO:individual_service |
|  | | csrc:Real_Time_Location_System |
|  | | NCIT:C16464 |
| **Broad Mappings:** | | csrc:IT_System |
