---
parent: Entities
title: csolink:AdministrativeOperationalExposure
grand_parent: Classes
layout: default
---

# Class: AdministrativeOperationalExposure


A administrative operational exposure is an intake of a particular administrative operation.

URI: [csolink:AdministrativeOperationalExposure](https://w3id.org/csolink/vocab/AdministrativeOperationalExposure)


---

![img](http://yuml.me/diagram/nofunky;dir:TB/class/[SystemTaxon],[NamedThing],[ExposureEvent],[ControlActor],[Attribute],[Agent],[AdministrativeOperationalToComponentserviceInteractionExposure],[AdministrativeOperationalExposure%7Ctimepoint:time_type%20%3F;id(i):string;iri(i):iri_type%20%3F;type(i):string%20%3F;name(i):label_type%20%3F;description(i):narrative_text%20%3F;source(i):label_type%20%3F]uses%20-.-%3E[ExposureEvent],[AdministrativeOperationalExposure]%5E-[AdministrativeOperationalToComponentserviceInteractionExposure],[AdministrativeOperation]%5E-[AdministrativeOperationalExposure],[AdministrativeOperation])
 ...
 *  is_a: [AdministrativeOperation](AdministrativeOperation.md) - A event intended for use in the diagnosis, cure, mitigation, repairing, or prevention of error
...
|  |  |  |
| --- | --- | --- |
| **Aliases:** | | administrative operational intake |
|  | | administrative operational dose |
|  | | system update |
